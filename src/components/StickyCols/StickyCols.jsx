...
const StickyCols = () => {
    ...
    if (isMobile) {
        return (
            <section className="w-full bg-[#f4efe7] lg:mb-20 px-4 py-10">
                <div className="flex flex-col gap-6">
                    <div className="rounded-[2rem] p-6 bg-[#e7decd]">
                        <h1 className="text-4xl text-[#6f6353] font-bold leading-auto">Enjoy the view
                            <br />
                            through—the wide
                            <br />
                            panoramic glass
                        ...
                        <div className="flex items-center gap-4 justify-between mt-6">
                            <div className="flex items-center gap-0 justify-center">
                                <h3 className="border-1 px-3 py-1 rounded-full text-[#8a7f6d]">1</h3>
                                <h3 className="border-1 px-3 py-1 rounded-full text-[#5a534a]">3</h3>
                            </div>
                    ...
                    <div className="rounded-[2rem] overflow-hidden h-72 bg-[#e7decd]">
                        <img src={colimg1} alt="img" className="w-full h-full object-cover" />
                    </div>
                    ...
                    <div className="rounded-[2rem] p-6 bg-[#e7decd]">
                        ...
                        <div className="flex items-center gap-4 justify-between mt-6">
                            <div className="flex items-center gap-0 justify-center">
                                <h3 className="border-1 px-3 py-1 rounded-full text-[#8a7f6d]">3</h3>
                                <h3 className="border-1 px-3 py-1 rounded-full text-[#5a534a]">3</h3>
                            </div>
                            <p className="text-[12px] font-medium"> Get closer to the desert nature than ever before
                                <br />
                    ...
                    <div className="rounded-[2rem] overflow-hidden h-72 bg-[#e7decd]">
                        <img src={colimg2} alt="img" className="w-full h-full object-cover" />
                    </div>
                    ...
                    <div className="rounded-[2rem] overflow-hidden h-72 bg-[#e7decd]">
                        <img src={colimg3} alt="img" className="w-full h-full object-cover" />
                    </div>
                </div>
            </section>
        );
    ...
    return (
        <section className="sticky-cols w-screen h-dvh overflow-hidden bg-[#f4efe7] lg:mb-20">
            <div className="sticky-cols-wrapper relative w-full h-screen">
                ...
                <div className="col col-3">
                    <div className="col-content-wrapper">
                        <h1 className="text-4xl font-bold leading-auto">Enjoy the view
                            <br />
                            through—the wide
                            <br />
                            panoramic glass
                        ...
                        <div className={`col-content-para flex items-center gap-4 justify-between ${reveal ? "ml-0" : "ml-6"}`}>
                            <div className="flex items-center gap-0 justify-center">
                                <h3 className="border-1 px-3 py-1 rounded-full text-[#8a7f6d]">{(reveal) ? "3" : "2"}</h3>
                                <h3 className="border-1 px-3 py-1 rounded-full text-[#5a534a]">3</h3>
                            </div>
                            <p className="text-[12px] font-medium"> Get closer to the desert nature than ever before
                                <br />
