...
import gbg1 from '../../assets/background4.png';
import gbg2 from '../../assets/background2.png';
import gbg3 from '../../assets/background3.png';
import gbg4 from '../../assets/background1.png';
        ...
        <section className="gallery-page4" ref={pageRef}>
            ...
            <div className="gallery-background">
                ...
                <div className="gallery-topText">
                    <h4><a href="http://localhost:5173/">Classic</a></h4>
                    <h3>(Scroll)</h3>
                </div>
                <div className="gallery-bottomText">
                    <div className='w-full flex justify-center items-center gap-0'>
                        <BsFillPlusCircleFill className='w-8 h-8 text-[#6f6353]' />
                        <h3>Classic  boasts refined aesthetics and a modern <br /> interior, creating an intimate retreat in a desert landscape</h3>
                    </div>
                    <div className="relative z-9 w-50 h-[0.1rem] bg-[#d9cfbd]">
                        <div className="progress-line absolute z-10 bg-[#181717] w-[33%] h-[0.1rem] top-1/2 -translate-y-1/2 left-0"></div>
                    </div>
                </div>
            </div>
            ...
            <div id="gallery-second" className="gallery-background2">
                ...
                <div className="gallery-bottomText">
                    ...
                    <div className="relative z-9 w-50 h-[0.1rem] bg-[#d9cfbd]">
                        <div className="progress-line absolute z-10 bg-[#181717] w-[67%] h-[0.1rem] top-1/2 -translate-y-1/2 left-0"></div>
                    </div>
                </div>
            </div>
            ...
            <div id="gallery-third" className="gallery-background2">
                ...
                <div className="gallery-bottomText">
                    ...
                    <div className="relative z-9 w-50 h-[0.1rem] bg-[#d9cfbd]">
                        <div className="progress-line absolute z-10 bg-[#181717] w-[100%] h-[0.1rem] top-1/2 -translate-y-1/2 left-0"></div>
                    </div>
                </div>
            </div>
        </section>
