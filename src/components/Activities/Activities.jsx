...
const Activities = () => {
    ...
    return (
        <section className="activities-section w-full min-h-[120vh] h-auto md:h-[120vh] p-8 mt-16">
            <p className='text-[.7rem] font-bold text-[#6a6155] activities-subtitle'>Ready for an advanture?</p>
            <div className="lg:mt-10 mt-7 activities-part origin-bottom">
                {activitiesLines.map((line, index) => (
                    <h1 key={index} className={`activities-heading text-[#181717] text-[3rem] md:text-[6rem] lg:text-[9.5rem] leading-[0.9]`} font-medium tracking-tighter>
            ...
            <div className="activities-sec w-full flex lg:flex-row flex-col justify-center items-start gap-10 lg:mt-0">
                ...
                <div className='lg:w-1/2 w-full text-[#6f6353] lg:text-[2rem] text-[1rem] md:leading-[1.1] lg:mt-0 mt-8 lg:pr-0'>
